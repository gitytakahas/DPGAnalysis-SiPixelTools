...
class SiPixelRawDumpPilot : public edm::EDAnalyzer {
public:

  /// ctor
  explicit SiPixelRawDumpPilot( const edm::ParameterSet& cfg);

  //explicit SiPixelRawDumpPilot( const edm::ParameterSet& cfg) : theConfig(cfg) {
  //consumes<FEDRawDataCollection>(theConfig.getUntrackedParameter<std::string>("InputLabel","source"));} 

  /// dtor
  virtual ~SiPixelRawDumpPilot() {}
...
//----------------------------------------------------------------------------------
SiPixelRawDumpPilot::SiPixelRawDumpPilot( const edm::ParameterSet& cfg) : theConfig(cfg) {
...
//----------------------------------------------------------------------------------------
void SiPixelRawDumpPilot::endJob() {
...
//----------------------------------------------------------------------
void SiPixelRawDumpPilot::beginJob() {
...
//-----------------------------------------------------------------------
void SiPixelRawDumpPilot::analyze(const  edm::Event& ev, const edm::EventSetup& es) {
...
DEFINE_FWK_MODULE(SiPixelRawDumpPilot);
